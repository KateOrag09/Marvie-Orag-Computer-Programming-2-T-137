# Marvie-Orag-Computer-Programming-2-T-137
Computer--Programming-T137/Major Activity 1.0/ElectricityBill.c
...
int main()
{
    ...
    if (total > 100)
    {
        printf("[Electricity Receipt]\n");
        printf("Customer ID#                    :%d\n", customerId);
        printf("unit Consumed                   :%d\n", unitConsumed);
        printf("unit Charges  %.2f per unit  :P %.2f\n", chargePerUnit, charge);
